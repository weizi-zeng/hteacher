    	...
    	<table id="dgData" style="height:400px"></table>
     	...
     	<div id="toolbar" style="padding:5px;height:auto">
     	 <div style="margin-bottom:5px">
            ...
            <a href="javascript:void(0)" onclick="deletemsg();" class="easyui-linkbutton" iconCls="icon-remove" >删除</a>
         </div>
          ...
          <form id="search_form" method="post">
                <table width="100%" cellspacing="1" cellpadding="0" border="0" class="form_table">
                    <tr>
                        ...
                        <td style="text-align: left; width:150px;">
                        	<a href="javascript:void(0)" onclick="searchmsgs();" class="easyui-linkbutton" icon="icon-search">查找</a>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
    ...
    <div id="edit_window" class="easyui-window" closed="true" title="数据维护" style="width: 740px;
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" fit="true" style="padding: 0px; background: #fff; border: 0px;">
                <form id="edit_form" name="edit_form" action="msg.php?act=ajax_save" method="post" enctype="multipart/form-data"  style="padding-top:20px;" onsubmit="return savecheck();">
                
                <div title="隐藏参数">
                    <input type="hidden" id="msg_id" name="msg_id" value="0" />
                </div>
                ...
                <table width="100%" cellspacing="1" cellpadding="0" border="0" class="form_table">
                	<tr>
                        ...
                        <td style="width:70%">
                        	<input id="msg_title" name="msg_title" class="easyui-validatebox" data-options="required:true"  maxlength="255" style="width: 400px" />
                        </td>
                    </tr>
                    <tr>
                        <th style="text-align: right">内容：</th>
                        <td style="width:70%">
                        	<textarea id="msg_content" name="msg_content"  rows="14" cols="20" class="easyui-validatebox" data-options="required:true"  maxlength="255" style="width: 400px"></textarea>
                        </td>
                    </tr>
