...
<head>
    ...
    <script src="js/duty_item.js" type="text/javascript"></script>
    	...
    	<table id="dgData" style="height:400px"></table>
     	...
     	<div id="toolbar" style="padding:5px;height:auto">
     	 <div style="margin-bottom:5px">
            ...
            <a href="javascript:void(0)" onclick="deleteduty_item();" class="easyui-linkbutton" iconCls="icon-remove" >删除</a>
         </div>
          ...
          <form id="search_form" method="post">
                <table width="100%" cellspacing="1" cellpadding="0" border="0" class="form_table">
                    <tr>
                        ...
                        <td style="text-align: left; width:150px;">
                        	<a href="javascript:void(0)" onclick="searchduty_items();" class="easyui-linkbutton" icon="icon-search">查找</a>
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
    ...
    <div id="edit_window" class="easyui-window" closed="true" title="数据维护" style="width: 480px;
        ...
        <div class="easyui-layout" fit="true">
            <div region="center" border="false" fit="true" style="padding: 0px; background: #fff; border: 0px;">
                ...
                <div title="隐藏参数">
                    <input type="hidden" id="duty_item_id" name="duty_item_id" value="0" />
                </div>
