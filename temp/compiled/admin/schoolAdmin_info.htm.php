...
?>
        <option value="<?php echo $this->_var['list']['code']; ?>" <?php if ($this->_var['list']['code'] == $this->_var['user']['school_code']): ?> selected="selected" <?php endif; ?> ><?php echo $this->_var['list']['name']; ?></option>
