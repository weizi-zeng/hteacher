  var me = {
        ...
        function loadGrid() {
            me.dgData.datagrid({
                ...
                columns: [[
				  { field: 'atype_id', title: 'ID', width: 60, align: 'center',  sortable: true,
					  sorter:function(a,b){
