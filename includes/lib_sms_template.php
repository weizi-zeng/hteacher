...
function sms_tmp_change_pwd_by_classAdmin($guardian, $password, $admin_name){
	$content = "尊敬的".$guardian["guardian_name"]."家长，您的密码已重置！您当前的账号密码为：".$guardian["guardian_phone"]."/".$password."，重置人：".$admin_name."，感谢您的使用！";
	return $content;
}
...
function sms_tmp_change_pwd_by_phone_guardian($guardian, $password){
	$content = "尊敬的".$guardian["guardian_name"]."家长，您的密码已重置！您当前的账号密码为：".$guardian["guardian_phone"]."/".$password."，感谢您的使用！";
	return $content;
}
...
function sms_tmp_change_pwd_by_phone_admin($admin, $password){
	$content = "尊敬的".$admin["name"]."管理员，您的密码已重置！您当前的账号密码为：".$admin["user_name"]."/".$password."，感谢您的使用！";
	return $content;
}
