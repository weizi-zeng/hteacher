...
<head>
    ...
    <script type="text/javascript">
		...
		function getGraph(){
			...
			var htm = '<iframe src="graph.php?act=history_score&subject='+subject+'&graph_width='+graph_width+'&graph_height='+graph_height+'" scrolling="auto" frameborder="0" style="width:100%;height:100%;"></iframe>';
			$("#graph_load").html(htm);
		}
