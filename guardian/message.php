...
elseif ($_REQUEST['act'] == 'view')
{
	...
	//如果不是自己提的问题，支持回复
	$not_mine = true;
	if($row['from_type']=='guardian' && $row['from_']==$_SESSION['guardian_id']){
		$not_mine = false;
	}
...
function msg_list($table)
{
    ...
    $where = " WHERE class_code='".$_SESSION["class_code"]."' and ((to_type='guardian' and to_='".$_SESSION["guardian_id"]."') or (from_type='guardian' and from_='".$_SESSION["guardian_id"]."')) ";
