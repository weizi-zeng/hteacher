...
/* 取得当前ecshop所在的根目录 */
define('ROOT_PATH', str_replace(SCHOOL_PATH . '/includes/init.php', '', str_replace('\\', '/', __FILE__)));
...
$smarty->template_dir  = ROOT_PATH . SCHOOL_PATH . '/templates';
$smarty->compile_dir   = ROOT_PATH . 'temp/compiled/school';
if ((DEBUG_MODE & 2) == 2)
{
