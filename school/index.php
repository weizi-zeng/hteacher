...
elseif ($_REQUEST['act'] == 'save_todolist')
{
    ...
    $sql = "UPDATE hteacher.ht_admin_user SET todolist='" . $content . "' WHERE user_id = " . $_SESSION['admin_id'];
    $GLOBALS['db']->query($sql);
}

elseif ($_REQUEST['act'] == 'get_todolist')
{
    $sql     = "SELECT todolist FROM hteacher.ht_admin_user WHERE user_id = " . $_SESSION['admin_id'];
